...
class Snake(tk.Canvas):
	...
	def load_assets(self):
		try:
			...
			self.snake_body = PIL.ImageTK.PhotoImage(self.snake_body_image)
	...
	def create_objects(self):
		self.create_text(
			100, 12, text = f"score {self.score} Speed: {moves_per_second}", tag = "score", fill = "vfff", font = ("TkdefaultFont", 14)
		)
